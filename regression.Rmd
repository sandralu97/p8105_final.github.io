...
In the regression analysis, we found that Biden's supporting rate in the seventeen battlegrounds states reported by all opinion polls was decreasing as the COVID-19 pandemic progress, suggesting that Trump was more "benefiting" from COVID-19. This could be due to the **"rally round the flag" effect**, which illustrates the phenomenon that there is a short-term surge of voter approval of present nation leader during a crisis or emergency situation.
...
We found that as the number of COVID-19 cases and deaths increased, Trump's supporting rate increased in the seventeen battleground states.
